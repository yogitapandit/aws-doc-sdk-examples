...
describe ObjectCopyEncryptWrapper do
  ...
  it "confirms the object was copied" do
    ...
    target_obj = wrapper.copy_object(target_bucket, "spec-target-key", "ServerSideEncryption")
  ...
  it "confirms error is caught when object can't be copied" do
    ...
    expect(wrapper.copy_object(target_bucket, "spec-target-key", "ServerSideEncryption")).to be_nil
  end
end
